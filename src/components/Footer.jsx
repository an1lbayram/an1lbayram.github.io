      ...
      <section id="social" className="py-5 text-center" ref={ref}>
        <div className={`container ${isVisible ? 'animate-fade-up' : 'opacity-0'}`}>
          ...
          <div className="d-flex flex-wrap gap-2 justify-content-center">
            ...
            <a className="btn btn-primary" href="https://ig.me/m/anl_bayram?text=Merhaba%2C%20%20Projelerinizi%20%C3%A7ok%20be%C4%9Fendim%2C%20birlikte%20%C3%A7al%C4%B1%C5%9Fmak%20i%C3%A7in%20sab%C4%B1rs%C4%B1zlan%C4%B1yorum!%20%20Sevgilerimle.%20" target="_blank" rel="noopener noreferrer" aria-label="Instagram'dan direkt mesaj gönder">{t('social-dm')}</a>
            <a className="btn btn-primary" href="https://dijital.link/an1lbayram" target="_blank" rel="noopener noreferrer" aria-label="Tüm sosyal bağlantılarım">{t("social-all")}</a>
          </div>
          <div className="mt-4">
